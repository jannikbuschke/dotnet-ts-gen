...
let internalTag =
  [
    ...
    "[\"MyRecordId\",\"00000000-0000-0000-0000-000000000000\"]"
    // Fields as record
    [ JsonUnionEncoding.NamedFields ], "{\"Case\":\"MyRecordId\",\"Fields\":{\"item\":\"00000000-0000-0000-0000-000000000000\"}}"
    // Untagged
    [ JsonUnionEncoding.Untagged ], "{\"item\":\"00000000-0000-0000-0000-000000000000\"}"
    // Single fields are unwrapped
    [ JsonUnionEncoding.UnwrapSingleFieldCases ], "{\"Case\":\"MyRecordId\",\"Fields\":\"00000000-0000-0000-0000-000000000000\"}" ]
