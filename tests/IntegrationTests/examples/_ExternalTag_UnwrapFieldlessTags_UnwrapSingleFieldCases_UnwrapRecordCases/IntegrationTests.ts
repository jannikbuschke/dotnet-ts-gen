...
export type MultiCaseMultiFields_Case_OneAnonField = {
  OneAnonField: ___.f__AnonymousType113051835<System.Int32, System.String>;
};
export type MultiCaseMultiFields_Case_OneField = { OneField: System.Int32 };
export type MultiCaseMultiFields_Case_TwoFields = {
  TwoFields: { item1: System.String; item2: System.Boolean };
};
export type MultiCaseMultiFields_Case_RecordField = { RecordField: Record };
export type MultiCaseMultiFields_Case_Records = {
  Records: { item1: Record; item2: Record; item3: System.Boolean };
};
...
export type SingleCaseUnion_Case_Value = { Value: System.Int32 };
...
export type GenericDu_Case_OneField<a, b> = { OneField: a };
export type GenericDu_Case_OneAnonFieldBool<a, b> = {
  OneAnonFieldBool: ___.f__AnonymousType174717633<System.Boolean>;
};
export type GenericDu_Case_OneAnonFieldAOption<a, b> = {
  OneAnonFieldAOption: ___.f__AnonymousType174717633<
    Microsoft_FSharp_Core.FSharpOption<a>
  >;
};
...
export type GenericDu_Case_OneField_a<a, b> = { OneField: a };
...
export type GenericDu_Case_OneField_b<a, b> = { OneField: a };
...
export type GenericDu_Case_OneField_ab<a, b> = { OneField: a };
...
export type GenericDu0_Case_OneField<a> = { OneField: a };
...
// GENERIC RECORD DU: a
export type GenericDu0_Case_OneField_a<a> = { OneField: a };
