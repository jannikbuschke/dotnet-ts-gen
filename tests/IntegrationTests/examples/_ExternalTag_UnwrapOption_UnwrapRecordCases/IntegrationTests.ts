...
export type SingleCaseUnion_Case_Value = { Value: { item: System.Int32 } };
...
export type GenericDu_Case_OneField_b<a, b> = { OneField: { item: a } };
...
export type GenericDu0_Case_OneField<a> = { OneField: { item: a } };
