...
export type MultiCaseMultiFields_Case_RecordField = {
  Case: 'RecordField';
  Fields: { item: Xunit.Record };
};
export type MultiCaseMultiFields_Case_Records = {
  Case: 'Records';
  Fields: { item1: Xunit.Record; item2: Xunit.Record; item3: System.Boolean };
};
...
export type SingleCaseUnion_Case_Value = {
  Case: 'Value';
  Fields: { item: System.Int32 };
};
...
export type GenericDu_Case_OneField<a, b> = {
  Case: 'OneField';
  Fields: { item: a };
};
...
export type GenericDu_Case_OneField_b<a, b> = {
  Case: 'OneField';
  Fields: { item: a };
};
...
export type GenericDu0_Case_OneField<a> = {
  Case: 'OneField';
  Fields: { item: a };
};
...
// GENERIC RECORD DU: a
export type GenericDu0_Case_OneField_a<a> = { Case: 'OneField'; Fields: a };
