...
export type Union_Case_CaseA = { CaseA: { item: System.Int32 } };
export type Union_Case_CaseB = { CaseB: { item: System.String } };
export type Union_Case_CaseC = { CaseC: { item: Record } };
