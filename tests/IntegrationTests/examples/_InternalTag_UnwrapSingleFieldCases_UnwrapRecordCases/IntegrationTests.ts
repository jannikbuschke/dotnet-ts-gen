...
export type MultiCaseMultiFields_Case_OneAnonField = {
  Case: 'OneAnonField';
} & ___.f__AnonymousType113051835<System.Int32, System.String>;
...
export type SingleCaseUnion_Case_Value = { Case: 'Value'; item: System.Int32 };
...
export type EnumLikeUnion_Case_A = { Case: 'A' };
export type EnumLikeUnion_Case_B = { Case: 'B' };
export type EnumLikeUnion_Case_C = { Case: 'C' };
...
export type GenericDu_Case_NoField<a, b> = { Case: 'NoField' };
export type GenericDu_Case_OneField<a, b> = { Case: 'OneField'; item: a };
export type GenericDu_Case_OneAnonFieldBool<a, b> = {
  Case: 'OneAnonFieldBool';
} & ___.f__AnonymousType174717633<System.Boolean>;
export type GenericDu_Case_OneAnonFieldAOption<a, b> = {
  Case: 'OneAnonFieldAOption';
} & ___.f__AnonymousType174717633<Microsoft_FSharp_Core.FSharpOption<a>>;
...
// GENERIC RECORD DU: a
export type GenericDu_Case_NoField_a<a, b> = { Case: 'NoField' };
export type GenericDu_Case_OneField_a<a, b> = { Case: 'OneField' } & a;
...
// GENERIC RECORD DU: b
export type GenericDu_Case_NoField_b<a, b> = { Case: 'NoField' };
export type GenericDu_Case_OneField_b<a, b> = { Case: 'OneField'; item: a };
...
export type GenericDu_Case_NoField_ab<a, b> = { Case: 'NoField' };
export type GenericDu_Case_OneField_ab<a, b> = { Case: 'OneField' } & a;
...
export type GenericDu0_Case_OneField<a> = { Case: 'OneField'; item: a };
...
// GENERIC RECORD DU: a
export type GenericDu0_Case_OneField_a<a> = { Case: 'OneField' } & a;
